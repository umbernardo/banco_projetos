        ...
        <div id="conteudo">
            ...
            <div class="conteudo_right">
                ...
                if (!empty($item) || !empty($a)) {
                    $projeto = $app->em->getRepository('Projetos')->find(decode($item));
                    ?>
                    <h4>Nome : <?= $projeto->getNome() ?></h4>
                    <p>
                        <?= $projeto->getResumo() ?>
                    </p>
                    <?php
                    if ($projeto->temArquivo()) {
                        ...
                        <a target="_blank" style="margin:10px;"
                           href="<?= $app->url(array('uploads', 'projetos', $projeto->getArquivo())) ?>"
                           class="btn-primario">Baixar PDF do projeto</a>
                        <?php
                    }
                    ?>
                    <hr/>
                    ...
                    $ssql = "SELECT * FROM tbl_projetos order by id DESC";
